...
<head>
    ...
    <title>ShopSphere - Vegetables</title>
    <style>
        /* Use same CSS as display_meat.php */
...
<h2 class="page-title">Our Fresh Vegetables</h2>
...
<?php
    endwhile;
    if(!$hasProducts){
        echo "<p style='grid-column:1 / -1; text-align:center;'>No vegetable products found.</p>";
    }
}
?>
